...
class CustomObtainAuthToken(ObtainAuthToken):
    ...
    def post(self, request, *args, **kwargs):
        serialzier = self.get_serializer(data=request.data, context={'reauest': request})
...
class ActivationApiView(GenericAPIView):
    ...
    def get(self, request, token, *args, **kwargs):
        try:
            ...
            return Response({'detail': 'token has beem expire'}, status=status.HTTP_400_BAD_REQUEST)
